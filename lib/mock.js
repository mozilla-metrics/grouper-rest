...
function postDoc (req, res) {
  ...
  req.on('end', function () {
    ...
    res.created().json("/docs/" + ns + "/" + doc.id)
  })
}
...
, 1364806: "I like the speed of the connection, and its new style of homepage"
...
, 1479325: "Мне очень понравился новый интерфейс. Он выполнен просто "
         + "замечательно! Еще я думал, что в бете сайты будут открываться "
